...
$result = mysqli_query($con, "SELECT * FROM tb_report WHERE deleted = 0");
        ...
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
				...
				?>
							...
							<td>
                            <a href="#" class="delete" data-toggle="modal" data-target="#deleteReportModal<?php echo $row['id_report'];?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xe872;</i></a>
                        	</td>
							</tr>
                </tbody>
				<!-- Open Modal HTML -->
